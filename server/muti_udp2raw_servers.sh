...
#nohup /root/speeder/speederv2_amd64 -s -l 0.0.0.0:50000 -r 127.0.0.1:1198 -f1:3,2:4,8:6,20:10 -k huayu888 --mode 1 >/var/log/speederv2.log &
#nohup /root/speeder/speederv2_amd64 -s -l 0.0.0.0:50001 -r 127.0.0.1:1199 -f20:10 -i 8 -k huayu888 --mode 1 >/var/log/speederv2.log &
