...
/usr/sbin/tc class add dev $EXTDEV parent 1:1 classid 1:16 htb rate ${speed3m}kbit ceil ${speed3m}kbit
/usr/sbin/tc class add dev $EXTDEV parent 1:1 classid 1:17 htb rate ${speed3m}kbit ceil ${speed3m}kbit
