...
#506
/usr/sbin/tc class add dev $EXTDEV parent 1:1 classid 1:14 htb rate ${speed7m}kbit ceil ${speed7m}kbit
/usr/sbin/tc class add dev $EXTDEV parent 1:1 classid 1:15 htb rate ${speed7m}kbit ceil ${speed7m}kbit
#tky
